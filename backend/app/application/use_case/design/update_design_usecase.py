...
from app.application.dto.design_dto import DesignLayerIn, DesignUpdate
...
class UpdateDesignUseCase:
    ...
    def execute(self, design_id: int, user_id: int, design_in: DesignUpdate) -> dict:
        ...
        update_data["layers"] = layers_data
        self.design_repo.update(design_id, update_data)

        return self.design_repo.get_by_id_with_details(design_id)
